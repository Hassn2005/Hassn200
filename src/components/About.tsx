      ...
      <div className="grid items-center gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:gap-14">
        <div className="relative">
          ...
          <div className="absolute -bottom-6 right-5 rounded-full border border-[#d6b5a8]/70 bg-[#fffaf7]/90 px-4 py-3 text-center shadow-[0_18px_45px_rgba(80,58,60,0.12)] backdrop-blur-sm">
            <div className="text-[10px] uppercase tracking-[0.2em] text-[#65504d]">Since</div>
        ...
        <div>
          ...
          <h2 className="brand-serif text-5xl leading-none text-[#2d1d1d] sm:text-6xl">A quiet luxury for daily styling.</h2>

          <p className="mt-6 max-w-xl text-base leading-8 text-[#5d4d4b] sm:text-lg">
            Dantil was imagined for women who understand that true elegance lives in the details. We create thoughtful accessories that carry a sense of ease, femininity, and confidence from morning to evening.
          </p>

          <p className="mt-4 max-w-xl text-base leading-8 text-[#5d4d4b] sm:text-lg">
            Every piece is selected with intention—soft structure, refined silhouettes, and a touch of romance that feels effortless, personal, and unforgettable.
          </p>

          <div className="mt-8 flex flex-wrap gap-4 text-sm text-[#4d3d3a]">
            <span className="rounded-full border border-[#d5b9b1] bg-[#f9f1ee] px-3 py-2">Refined femininity</span>
            <span className="rounded-full border border-[#d5b9b1] bg-[#f9f1ee] px-3 py-2">Boutique experience</span>
            <span className="rounded-full border border-[#d5b9b1] bg-[#f9f1ee] px-3 py-2">Timeless finishes</span>
          </div>
        </div>
      </div>
    </section>
